...
static std::vector<std::filesystem::path> scene_filepaths = {
    ...
    "../resources/specular_roughness_test/spheres_test_scene.obj",
    ...
    "../resources/transmission_roughness_test/spheres_test_scene.obj",
    "../resources/transmission_test_sphere/sphere.obj",
    "../resources/specular_transmission_test/spheres_test_scene.obj",
    "../resources/specular_transmission_roughness_test/spheres_test_scene.obj",
